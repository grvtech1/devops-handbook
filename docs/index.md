...
![The two loops — how all of DevOps fits together](assets/devops_two_loops_mental_model.png)
...
| Part | Chapter | Topic |
|------|---------|-------|
| **0 — Pre-flight** | [00a — Terminal, YAML, Git, HTTP, Networking](00a-preflight.md) | Prerequisites zero |
| | [00b — Toolchain & AWS account setup](00b-setup-runbook.md) | Install everything once |
| **I — Core toolchain** | [01 — M0 Foundations](01-M0-foundations.md) | Linux, shell, SSH, bash scripting |
| | [02 — M1 Terraform](02-M1-terraform.md) | Infrastructure as Code |
| | [03 — M2 Ansible](03-M2-ansible.md) | Configuration management |
| | [04 — M3 Docker](04-M3-docker.md) | Containers from scratch |
| | [05 — M4 Kubernetes Core](05-M4-kubernetes-core.md) | Orchestration fundamentals |
| | [06 — M5 Sizing & Cost](06-M5-sizing-and-cost.md) | Right-sizing, FinOps basics |
| | [07 — M6 CI/CD](07-M6-cicd.md) | Pipelines, GitHub Actions, ArgoCD |
| | [08 — M7 GitOps](08-M7-gitops.md) | GitOps patterns and workflows |
| **II — Systems thinking** | [09 — The connected system](09-connected-system.md) | 2 loops · 8 bridges · 5 golden threads |
| **III — Operate** | [10 — M8 Observability & SRE](10-M8-observability-sre.md) | Metrics, logs, traces, SLOs |
| | [11 — M9 Advanced K8s internals](11-M9-advanced-k8s-internals.md) | Control plane deep dive |
| **IV — Capstones** | [12 — Capstone: URL Shortener](12-capstone-url-shortener.md) | End-to-end solo project |
| | [13 — Capstone: MicroShop](13-capstone-microshop.md) | Microservices on cloud |
| **V — Reference & outcome** | [14 — Interview bank](14-interview-bank.md) | 100+ real interview questions |
| | [15 — Roadmap M11–M18](15-roadmap-M11-M18.md) | What comes after this handbook |
| | [16 — Reference appendix](16-reference-appendix.md) | Cheat sheets, quick references |
| | [17 — Flashcards](17-flashcards.md) | ~190-card recall deck |
| | [18 — Career & job-ready](18-career-job-ready.md) | Resume, portfolio, job checklist |
| **Index** | [00-INDEX — Full spine](00-INDEX.md) | Chapter map and reading order |
...
| **Interview** | Work through the interview bank cold, then review gaps | [`14-interview-bank.md`](14-interview-bank.md) |

> **Spaced review matters.** After finishing each chapter, schedule a short review session 1 day later, then 1 week later. The flashcard deck in [`17-flashcards.md`](17-flashcards.md) is built for exactly this.
...
→ Begin at [`00a-preflight.md`](00a-preflight.md) — it covers everything you need before touching any DevOps tool.

**Already comfortable with Linux, Git, and basic networking?**
→ Skim the [`00-INDEX.md`](00-INDEX.md) spine to orient yourself, then jump to [`01-M0-foundations.md`](01-M0-foundations.md).

**Just want to browse and decide?**
→ Read [`09-connected-system.md`](09-connected-system.md) — if that chapter's mental model resonates, you will enjoy the rest.
...
→ Full job-ready checklist: [`18-career-job-ready.md`](18-career-job-ready.md)

---

## Provenance & license

This handbook was consolidated from approximately 20 personal study documents, lab notes, and interview-prep notes accumulated over an extended learning journey — all preserved in [`_source-archive/`](https://github.com/grvtech1/devops-handbook/tree/main/_source-archive) for reference.

It is published here in the hope that it saves the next learner weeks of hunting for the right mental model.

**License:** [Creative Commons Attribution 4.0 International (CC BY 4.0)](https://github.com/grvtech1/devops-handbook/blob/main/LICENSE) — free to use, share, and adapt with attribution.
